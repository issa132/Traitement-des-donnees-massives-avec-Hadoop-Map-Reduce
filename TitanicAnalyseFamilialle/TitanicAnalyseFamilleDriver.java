...
import TitanicAnalyseFamilialle.TitanicAnalyseFamilleMapper;
import TitanicAnalyseFamilialle.TitanicAnalyseFamilleReducer; 



public class TitanicAnalyseFamilleDriver extends Configured implements Tool {
	@Override
	...
	//permet de réduire les données localement avant de les envoyer au réducteur.
	    ...
	    */
	      ...
	      job.setJobName("Analyse des membres de la famille du Titanic");
	      job.setJarByClass(TitanicAnalyseFamilleDriver.class);
	      FileInputFormat.addInputPath(job, new Path(args[0]));
	      FileOutputFormat.setOutputPath(job, new Path(args[1]));
	      
	      //job.setJarByClass(TitanicSurvivalByGender.class);
	      job.setMapperClass(TitanicAnalyseFamilialle.TitanicAnalyseFamilleMapper.class);  
	      //job.setCombinerClass(TitanicClassAgeReducer.class);
	      job.setReducerClass(TitanicAnalyseFamilialle.TitanicAnalyseFamilleReducer.class);
	  ...
	  public static void main(String[] args) throws Exception {
	    int exitCode = ToolRunner.run(new TitanicAnalyseFamilleDriver(), args);
