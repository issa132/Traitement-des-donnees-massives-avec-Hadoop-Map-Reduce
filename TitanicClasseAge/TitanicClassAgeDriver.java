...
public class TitanicClassAgeDriver extends Configured implements Tool {
	@Override
	...
	//permet de réduire les données localement avant de les envoyer au réducteur.
	    ...
	    */
	      ...
	      job.setJarByClass(getClass());
	      //job.setJarByClass(TitanicClassAgeDriver.class);
	      job.setMapperClass(TitanicClassAgeMapper.class);
	      //job.setCombinerClass(TitanicClassAgeReducer.class);
	      job.setReducerClass(TitanicClassAgeReducer.class);
	  ...
	  public static void main(String[] args) throws Exception {
	    int exitCode = ToolRunner.run(new TitanicClassAgeDriver(), args);
