...
public class SurvieParSexeReducer extends Reducer<Text, IntWritable, Text, Text> {
   ...
   try {
	...
	//et on met à jour maxValue avec cette température maximale.
	  ...
	  */
	  ...
	  double tauxDeces = nombreTotalVoyageur > 0 ? (double) mort / nombreTotalVoyageur * 100 : 0;
	  
	  // resultat
	  String resulatPrint = String.format("Total: %d, Survivant: %d, Pourcentage Survivant: %.2f%% , Mort: %d, Pourcentage Deces: %.2f%%" , nombreTotalVoyageur, survivant, tauxSurvie, mort, tauxDeces);
